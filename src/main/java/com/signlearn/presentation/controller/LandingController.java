...
public class LandingController extends BaseController {
    ...
    @FXML private Button aboutBtn, contactBtn, loginBtn, signupBtn, landingHeroSignupBtn, landingHeroLoginBtn;
    ...
    public void postInit() {
        ...
        landingHeroLoginBtn.setOnAction(e -> router.goTo(View.ABOUT));
    }
}
